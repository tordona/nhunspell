...
using System.Collections;
    ...
    public class Thes
    {
        ...
        Dictionary<string, WordMeaningInternal[]> synonyms = new Dictionary<string, WordMeaningInternal[]>();
        public Thes()
        {
        }
        ...
        public void LoadOpenOffice(byte[] datBytes)
        {
            ...
            int synonymLines = 0;
            string word = null;
            List<WordMeaningInternal> meanings = new List<WordMeaningInternal>();
            ...
            while (currentPos < datBytes.Length)
            {
                ...
                if (lineText != null && lineText.Length > 0)
                {
                    ...
                    else
                    {
                        ...
                        WordMeaningInternal meaning = new WordMeaningInternal(description, synonyms.ToArray());
